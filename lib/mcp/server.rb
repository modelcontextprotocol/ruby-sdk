...
module MCP
  ...
  class Server
    ...
    #
    # @yield [params] The request params containing an optional pagination cursor.
    # @yieldreturn [Array<Hash>, Hash] Resources, optionally with `:nextCursor`.
      ...
      ->(params) {
        ...
        instrument_call(
          ...
          when Methods::RESOURCES_LIST
            normalize_resources_list_result(
