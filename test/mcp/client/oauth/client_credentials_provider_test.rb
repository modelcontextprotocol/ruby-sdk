    ...
    module OAuth
      class ClientCredentialsProviderTest < Minitest::Test
        ...
        def test_initialize_keeps_the_http_client_customizer
          customizer = ->(_faraday) {}
          provider = ClientCredentialsProvider.new(client_id: "cc-client", client_secret: "cc-secret", http_client_customizer: customizer)

          assert_same(customizer, provider.http_client_customizer)
          assert_nil(ClientCredentialsProvider.new(client_id: "cc-client", client_secret: "cc-secret").http_client_customizer)
        end
        ...
        def test_initialize_rejects_a_non_callable_http_client_customizer_before_writing_credentials
          ...
          error = assert_raises(ArgumentError) do
            ClientCredentialsProvider.new(client_id: "cc-client", client_secret: "cc-secret", storage: storage, http_client_customizer: "recorder")
          end
