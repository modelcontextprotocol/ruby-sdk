...
module MCP
  class ServerTest < ActiveSupport::TestCase
    ...
    test "#logging_level= returns an error object when invalid log level is provided" do
      server = Server.new(
        tools: [TestTool],
    ...
    test "#logging_level= returns an error object when server has not logging capability" do
      server = Server.new(
        tools: [TestTool],
        configuration: Configuration.new(validate_tool_call_arguments: true),
        capabilities: {
